    ...
    positions: [
        {
            ...
            assortment: {
                meta: {
                    href:
                        "https://online.moysklad.ru/api/remap/1.2/entity/product/eeef177f-f648-11e5-8a84-bae50000007a",
                    type: "product",
                    mediaType: "application/json",
                },
            },
...
const responseBody = {
    ...
    state: {
        meta: {
            href:
                "https://online.moysklad.ru/api/remap/1.2/entity/processingorder/metadata/states/fb56c504-2e58-11e6-8a84-bae500000069",
            type: "state",
            mediaType: "application/json",
        },
    },
    organizationAccount: {
        meta: {
            href:
                "https://online.moysklad.ru/api/remap/1.2/entity/organization/850c8195-f504-11e5-8a84-bae50000015e/accounts/3a30e844-016f-11e6-9464-e4de00000068",
            type: "account",
            mediaType: "application/json",
        },
    },
    ...
    positions: {
        meta: {
            href:
                "https://online.moysklad.ru/api/remap/1.2/entity/processingorder/c49e83b3-01af-11e6-9464-e4de00000026/positions",
            metadataHref:
...
describe("POST", function () {
    ...
    it("POST entity/processingorder", async function () {
        ...
        const response = await fetch(`${url}`, options, requestBody);
